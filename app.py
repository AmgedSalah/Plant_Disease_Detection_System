...
# app = Flask(__name__)
# model = tf.keras.models.load_model("model/plant_disease_detect_model_pwp_quantized.tflite")
...
# # تحميل النموذج باستخدام TensorFlow Lite
# interpreter = tf.lite.Interpreter(model_path="model/plant_disease_detect_model_pwp_quantized.tflite")
# interpreter.allocate_tensors()

# # الحصول على معلومات عن المدخلات والمخرجات للنموذج
# input_details = interpreter.get_input_details()
# output_details = interpreter.get_output_details()
...
#     feature = tf.keras.utils.img_to_array(image)
#     feature = np.expand_dims(feature, axis=0)
#     feature = np.float32(feature)  # تحويل القيمة إلى float32 كما يتطلب TensorFlow Lite
#     return feature
